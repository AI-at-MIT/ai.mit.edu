...
export const initiative_data : {[key: string]: InitiativeInterface} = {
  aim: {
    ...
    url: getAssetPath("/"),
    icon: getAssetPath("/icons/aim-icon-at.svg"),
    backdrop: getAssetPath("/backdrops/aim-backdrop.svg"),
  ...
  l: {
    ...
    url: getAssetPath("/labs"),
    icon: getAssetPath("/icons/labs-icon.svg"),
    backdrop: getAssetPath("/backdrops/labs-backdrop.svg"),
  ...
  w: {
    ...
    url: getAssetPath("/workshops"),
    icon: getAssetPath("/icons/workshops-icon.svg"),
    backdrop: getAssetPath("/backdrops/workshops-backdrop.svg"),
  ...
  p: {
    ...
    url: getAssetPath("/permeate"),
    icon: getAssetPath("/icons/permeate-icon.svg"),
    backdrop: getAssetPath("/backdrops/permeate-backdrop.svg"),
  ...
  r: {
    ...
    url: getAssetPath("/reading"),
    icon: getAssetPath("/icons/reading-icon.svg"),
    backdrop: getAssetPath("/backdrops/reading-backdrop.svg"),
