...
export const descriptions = {
  ...
  "w": "Each introductory workshop is comprised of a brief theory lecture and an interactive coding-based lab. Available for all MIT students regardless of experience.",
...
export const backgrounds = {
  ...
  "g" : "background-generator",
  "s" : "background-speakers",
