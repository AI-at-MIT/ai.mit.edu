  ...
  return (
      <div ref={cardRef}>
        <div
          ...
          className={`transition duration-150 ${buttonHovered ? "" : "active:scale-95"} group desktop overflow-hidden transition-all duration-200 max-h-[250px] max-w-[250px] m-5 group rounded-2xl border border-transparent px-5 py-4 hover:border-neutral-700 hover:bg-neutral-800/30 flex flex-row justify-start items-center ${expanded ? "max-w-[800px] max-h-[350px]":""}`}
        >
...

          {
            <div className={`ml-4 transition-all   ${expanded ? "opacity-100 delay-100" : "opacity-0 delay-0 duration-0"}`}>
              ...
              <div className="flex justify-end">
                  ...
                  >
                  <div className={`group transition duration-100 active:scale-95 ${initiative.border_class} border-2  text-xl w-48 h-16 mt-8 rounded-full border border-transparent px-5 py-3 flex items-center justify-center `}>
        ...
        <div
          onClick={handleCardClick}
          className={`mobile duration-200  overflow-hidden transition-all max-h-[250px] max-w-[250px] m-10 group rounded-2xl border border-transparent px-5 py-4 hover:border-neutral-700 hover:bg-neutral-800/30 justify-center items-center ${expanded ? "max-w-[800px] max-h-[800px]":""}`}
        >
